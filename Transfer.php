...
//CONNECTING TO THE DATABASE
    ...
    $username = "id17279286_sparkbank"; 
    $password = "&&2?C(1w@tVT}>B@"; 
    $dbname = "id17279286_bankingdb";
...
<div class = 'transferMoney'>
    ...
    <!-- To structurise form it is put in a table--onsubmit="return validateForm()"-->
        ...
        <tr>
            ...
            <td><input type="number" name="payerID"  min=1000 required  ><td>
        </tr>

        <!-- ROW 2 : PAYEE ACCOUNT ID IS ASKED-->
        <tr>
            <td>Receiver Account No</td>
            <td><input type="number" name="payeeID" min=1000 required ><td>
        </tr>

        <!-- ROW 3 : AMOUNT TO BE TRANSFERRED IS ASKED-->
        <tr>
            <td>Transfer Amount (in Rupees)</td>
