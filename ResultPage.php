...
<head> 
    ...
    #Table th { padding-top: 12px; padding-bottom: 12px; text-align:left; background-color: #D2691E; color:white; }
...
<?php 
    ...
    //These variables are collecting form data
      ...
      //BELOW CODE RUNS WHEN ALL DETAILS ENTERED BY USER ARE CORRECT OR NOT
          ...
          echo "<h1 style='text-align: center'>Transaction Successfully Completed</h1>
                <p  style='text-align: center; font-size:27px;'>Details of sender and Receiver are as follows<p>
                <table id = 'Table'>
                <tr>
                <th></th>
                <th>Account No</th>
  ...
  //IF ENDS HERE    
      ...
      ?>
      <p1>All transactions are up to date</p1>
      <?php
  }
